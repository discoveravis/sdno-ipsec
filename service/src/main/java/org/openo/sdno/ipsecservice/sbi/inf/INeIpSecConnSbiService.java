...
/**
 * AC controller south branch interface. <br/>
 * 
 * @author
...
public interface INeIpSecConnSbiService extends IService {
     ...
     * @since SDNO 0.5
     */
    ResultRsp<List<NeIpSecConnection>> createIpSecNeConnection(List<NeIpSecConnection> ipSecConnectionList)
     ...
     * @since SDNO 0.5
     */
    ResultRsp<String> deleteIpSecConnection(List<NeIpSecConnection> ipSecConnectionList) throws ServiceException;
}
