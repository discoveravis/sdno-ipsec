...
public class DriverRegisterManager {
    ...
    private static final String DRIVER_REGISTER_FILE =
            "src/integration-test/resources/site2dcdriver/registerdriver.json";

    private static final String DRIVER_UNREGISTER_FILE =
            "src/integration-test/resources/site2dcdriver/unregisterdriver.json";
